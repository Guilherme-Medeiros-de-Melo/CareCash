...
public class LoginUsu extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel8.setText("Ainda não possui conta? Registre-se clicando em Registrar ali embaixo");

        txtErro.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(layout.createSequentialGroup()
                            .addGap(74, 74, 74)
                            .addComponent(txtErro, javax.swing.GroupLayout.PREFERRED_SIZE, 279, javax.swing.GroupLayout.PREFERRED_SIZE))))
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addComponent(jLabel8)
                .addGap(18, 18, 18)
                .addComponent(txtErro, javax.swing.GroupLayout.PREFERRED_SIZE, 39, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(BtnLogin)
                    .addComponent(BtnRegistrar)
    ...
    private void BtnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnLoginActionPerformed
        try{
            ...
            Usuario usu = new Usuario(txtUsu.getText(), aux);
            ControllerUsuario con = new ControllerUsuario();
            int usuValido = con.validar(usu);
            if (usuValido > 0){
                new MenuUsu(usuValido, "Nenhum", "").setVisible(true);
                this.setVisible(false);
            }
            else{
                txtErro.setText("Login errado ou inexistente");
            }
